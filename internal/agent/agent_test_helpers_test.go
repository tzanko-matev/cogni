...
func (e *fakeExecutor) Execute(_ context.Context, call agent.ToolCall) tools.CallResult {
	e.calls++
...
func (e *verboseExecutor) Execute(_ context.Context, call agent.ToolCall) tools.CallResult {
